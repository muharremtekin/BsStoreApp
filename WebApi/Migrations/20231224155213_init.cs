    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Faulty product", false, 2, new DateTime(2023, 12, 24, 15, 52, 13, 240, DateTimeKind.Utc).AddTicks(4126) },
                    { 2, "Faulty product", false, 1, new DateTime(2023, 12, 24, 15, 52, 13, 240, DateTimeKind.Utc).AddTicks(4130) }
                });
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Model", "Name", "Price" },
                values: new object[,]
                {
                    { 1, 1, "Asus ZendBook", "Laptop", 999m },
                    { 2, 2, "IPhone 14 Pro", "Phone", 999m },
                    { 3, 2, "Clean Code", "Laptop", 100m }
                });
